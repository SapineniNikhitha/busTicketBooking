...
<body>
    ...
    %>
		...
		<div class="table-responsive">
			...
			<table
				class="table table-hover table-bordered bg-white shadow text-center">
            ...
            %>
					...
					<tr>
						...
						<td><a
							href="editBooking.jsp?bookingId=<%= b.getBookingId() %>"
							class="btn btn-warning btn-sm"> Edit </a> <a
							href="cancelBooking?bookingId=<%= b.getBookingId() %>"
            ...
            %>
					...
					<tr>
						<td colspan="5" class="text-danger fw-bold">No booking
							history found</td>
					</tr>
