	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (rs.next()) {
				...
				out.println("Bus ID : " + rs.getInt("bus_id") + "<br>");

				out.println("Bus Name : " + rs.getString("bus_name") + "<br>");

				out.println("Fare : " + rs.getDouble("fare") + "<br>");

				out.println("Available Seats : " + rs.getInt("available_seats") + "<br><br>");
			}
